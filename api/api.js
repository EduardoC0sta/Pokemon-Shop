...
const app = express();
const SECRET_KEY = 'chave-desenvolvimento';
...
const db = {
    ...
    pelucias: [
        ...
        {
            id: 102, sku: "PL-PIKA-01", nome: 'Pelúcia Pikachu Clássico', regiao: 'kanto', preco: 270.00,
            imagem: '/img/pikachu-plush.jpg', estoque: 30, emEstoque: true, emDestaque: true, categoria: "Pelúcia",
        ...
        {
            id: 103, sku: "PL-MIMIK-01", nome: 'Pelúcia Mimikyu', regiao: 'alola', preco: 260.00, 
            imagem: '/img/mimikyu-plush.jpg', estoque: 12, emEstoque: true, emDestaque: false, categoria: "Pelúcia",
        ...
        {
            id: 104, sku: "PL-FLUT-01", nome: 'Pelúcia Flutter Mane', regiao: 'paldea', preco: 300.00,
            imagem: '/img/fluttermane-plush.jpg', estoque: 8, emEstoque: true, emDestaque: false, categoria: "Pelúcia",
        ...
        {
            id: 105, sku: "PL-PIKA-KIMONO-01", nome: 'Pelúcia Pikachu Kimono', regiao: 'kanto', preco: 290.00,
            imagem: '/img/pikachu-plush-kimono.jpg', estoque: 0, emEstoque: false, emDestaque: false, categoria: "Pelúcia",
...
app.get("/api/produtos/pelucias", (req, res) => res.status(200).json(db.pelucias));
app.get("/api/produtos/tcg", (req, res) => res.status(200).json(db.tcg));
