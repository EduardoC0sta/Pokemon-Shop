...
export class Pelucia implements OnInit {
  ...
  todosOsProdutos: Produto[] = [
    { id: 101, nome: 'Pelúcia Wooper', regiao: 'johto', preco: 200.00, precoAntigo: 250.00, imagens: ['img/wopper-plush.jpg', 'img/wopper-plush-2.jpg'], link: '/produto' },
    { id: 102, nome: 'Pelúcia Pikachu Clássico', regiao: 'kanto', preco: 270.00, imagens: ['img/pikachu-plush.jpg', 'img/pikachu-plush-2.jpg'], link: '/produto' },
    { id: 103, nome: 'Pelúcia Mimikyu', regiao: 'alola', preco: 260.00, imagens: ['img/mimikyu-plush.jpg', 'img/mimikyu-plush-2.jpg'], link: '/produto' },
    { id: 104, nome: 'Pelúcia Flutter Mane', regiao: 'paldea', preco: 300.00, imagens: ['img/fluttermane-plush.jpg', 'img/fluttermane-plush-2.jpg'], link: '/produto' },
    { id: 105, nome: 'Pelúcia Pikachu Kimono', regiao: 'kanto', preco: 290.00, imagens: ['img/pikachu-plush-kimono.jpg', 'img/pikachu-plush-kimono-2.jpg'], link: '/produto' }
  ];
